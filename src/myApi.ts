...
> extends HttpClient<SecurityDataType> {
  ...
  carVariants = {
     ...
     * @secure
     */
    carVariantControllerCreateVariant: (
      id: string,
      data: CreateCarVariantDto,
      params: RequestParams = {}
    ) =>
     ...
     * @secure
     */
    carVariantControllerRemoveVariant: (
      id: string,
      params: RequestParams = {}
    ) =>
